...
|---|---|---|
| **AdversaryGraph — Primary Flagship** | Integrated CTI-to-detection platform and public research interface. The live browser workspace connects 160 ATT&CK groups, 656 techniques, correlated CTI/IR reporting, detection logic, hunting guidance, evidence assessment, coverage analysis, actor similarity, and the wider 1200km ecosystem. The self-hosted platform adds AI-assisted report analysis, campaigns, stored investigations, and API workflows. | [Live Intelligence Workspace](https://1200km.com/threat-matrix/) · [Project Hub](https://1200km.com/adversarygraph/) · [Docs](https://1200km.com/adversarygraph-docs/) · [Repo](https://github.com/anpa1200/adversarygraph) · [1200km Article](https://1200km.com/articles/adversarygraph-v2-self-hosted-ai-cti-platform.html) · [Medium](https://1200km.com/articles/adversarygraph-v2-self-hosted-ai-cti-platform.html) |
