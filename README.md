...
| **CTI as a Code** | CTI methodology lab and structured training framework. Docker Compose stack (OpenCTI · TheHive 5 · Cortex · Elastic SIEM) on one Linux host. 8 analyst assignments across 4 operational modes: reactive DFIR, proactive threat modeling, full-cycle CTI program build, and adversary emulation with PASS/PARTIAL/FAIL coverage scoring. Template-driven, version-controlled, evidence-traced investigations — from intake call to deployed Sigma rule. | [Site](https://anpa1200.github.io/CTI_as_a_Code/) · [Repo](https://github.com/anpa1200/CTI_as_a_Code) |
