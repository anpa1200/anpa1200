...
![Portfolio stars](https://img.shields.io/badge/Portfolio%20stars-85-yellow)
...
|---|---|---|
| **AdversaryGraph — Primary Flagship** | Integrated CTI-to-detection platform and public research interface. The live browser workspace connects ATT&CK groups, techniques, correlated CTI/IR reporting, detection logic, hunting guidance, evidence assessment, coverage analysis, actor similarity, and the wider 1200km ecosystem. The current self-hosted v5.5 platform adds AI-assisted report/log analysis, IOC enrichment, CVE Library correlation, Asset Attack Surface Mapping, Attack Simulation with SIEM validation, MalwareGraph-backed malware-analysis triage, OpenCTI/STIX/TAXII/MISP workflows, detection-rule handoff, observability, API workflows, screenshot-backed documentation, native authentication, expanded RBAC, sessions, MFA workflow support, audit history, and trusted proxy SSO metadata. | [Live Intelligence Workspace](https://1200km.com/threat-matrix/) · [Project Hub](https://1200km.com/adversarygraph/) · [Docs](https://1200km.com/adversarygraph-docs/) · [Platform Guide](https://1200km.com/adversarygraph-docs/platform-guide/) · [Capabilities](https://1200km.com/adversarygraph-docs/capabilities/) · [Authentication](https://1200km.com/adversarygraph-docs/authentication-and-users/) · [Repo](https://github.com/anpa1200/adversarygraph) · [Release Article](https://medium.com/@1200km/adversarygraph-v5-0-from-cti-mapping-to-attack-simulation-and-siem-validation-21873b2a6c39) |
