...
![GitHub followers](https://img.shields.io/badge/GitHub%20followers-21-blue)
![Public repos](https://img.shields.io/badge/Public%20repos-81-blue)
![Portfolio stars](https://img.shields.io/badge/Portfolio%20stars-86-yellow)
![Portfolio forks](https://img.shields.io/badge/Portfolio%20forks-14-lightgrey)
...
## Flagship CTI And Security Research Projects

| Project | Why review it | Links |
|---|---|---|
| **AdversaryGraph — Primary Flagship** | Integrated CTI-to-detection platform and public research interface. The live browser workspace connects ATT&CK groups, techniques, correlated CTI/IR reporting, detection logic, hunting guidance, evidence assessment, coverage analysis, actor similarity, and the wider 1200km ecosystem. The current self-hosted v6.0 release package includes AI-assisted report/log analysis, IOC and JA3/JA4 enrichment, CVE Library correlation, Threat Radar, EMB3D, Asset Attack Surface Mapping, Attack Simulation with SIEM validation, MalwareGraph-backed malware-analysis triage, OpenCTI/STIX/TAXII/MISP workflows, detection-rule handoff, observability, API workflows, native authentication, expanded RBAC, sessions, MFA workflow support, audit history, trusted proxy SSO metadata, a reproducible release gate, rollback guidance, sanitized screenshot evidence, and case studies. | [Live Intelligence Workspace](https://1200km.com/threat-matrix/) · [Project Hub](https://1200km.com/adversarygraph/) · [Docs](https://1200km.com/adversarygraph-docs/) · [v6 Readiness](https://1200km.com/adversarygraph-docs/release-readiness-v6/) · [v6 Case Studies](https://1200km.com/adversarygraph-docs/case-studies-v6/) · [Platform Guide](https://1200km.com/adversarygraph-docs/platform-guide/) · [Capabilities](https://1200km.com/adversarygraph-docs/capabilities/) · [Authentication](https://1200km.com/adversarygraph-docs/authentication-and-users/) · [Repo](https://github.com/anpa1200/adversarygraph) · [Release Article](https://medium.com/@1200km/adversarygraph-v5-0-from-cti-mapping-to-attack-simulation-and-siem-validation-21873b2a6c39) |
| **CTI Analyst Field Manual** | Primary flagship. Practical CTI tradecraft manual covering evidence discipline, source reliability, confidence language, attribution, infrastructure pivoting, ATT&CK usage, hunting hypotheses, detection backlog, SOC handoff, and reusable analyst templates. | [Site](https://1200km.com/cti-analyst-field-manual/) · [Repo](https://github.com/anpa1200/cti-analyst-field-manual) |
| **Operation Desert Hydra** | Complete CTI-to-detection pipeline. 71 source candidates reviewed, 8 promoted (CISA, INCD, vendor), 10 procedure records with Observed/Reported/Assessed evidence labels, OpenCTI 6.2 knowledge graph, 11 detection records with SIEM-agnostic pseudologic, Ansible-provisioned Windows 10 lab. **14 PASS / 1 PARTIAL / 1 FAIL** across 16 rule checks. 16 of 21 ATT&amp;CK techniques (76%) fully lab-validated. One-command reproducible. MuddyWater / Seedworm — widely reported by government and vendor sources as Iran-linked activity associated with MOIS. | [Site](https://1200km.com/operation-desert-hydra/) · [Repo](https://github.com/anpa1200/operation-desert-hydra) · [Detection Atlas](https://1200km.com/operation-desert-hydra/docs/phase-4-detection-atlas) · [Validation Results](https://1200km.com/operation-desert-hydra/docs/phase-5-results) · [Coverage Matrix](https://1200km.com/operation-desert-hydra/docs/phase-6-coverage-matrix) · [Article](https://medium.com/@1200km/operation-desert-hydra-ai-assisted-cti-pipeline-muddywater-to-kibana-34da7917acf0) |
| **Israel Government Threat Actors CTI** | Applied sector/actor CTI. Public-source defensive knowledge base for threat actors, personas, malware families, TTPs, detection opportunities, and Israeli public-sector / critical-infrastructure exposure. | [Site](https://1200km.com/israel-government-threat-actors-cti/) · [Repo](https://github.com/anpa1200/israel-government-threat-actors-cti) · [Reports](https://github.com/anpa1200/CTI) |
| **Customer-Driven AI CTI Project** | Delivery methodology. Gate-controlled CTI-to-detection workflow from customer requirements, PIRs/SIRs, source evaluation, and evidence handling to detection backlogs, SOC handoff, executive reporting, and measurable defensive outcomes. | [Site](https://1200km.com/customer-driven-ai-cti-project/) · [Repo](https://github.com/anpa1200/customer-driven-ai-cti-project) · [Article](https://medium.com/@1200km/customer-driven-ai-cti-project-c0db3cdc1830) |
...
| **CVSS v4.0 Field Guide** | Practical guide for vulnerability prioritization, scoring logic, exploitability context, and decision support. | [Guide](https://1200km.com/cvss/) · [Tool repo](https://github.com/anpa1200/cvss_4.0) · [Article](https://medium.com/bugbountywriteup/cvss-v4-0-the-practical-field-guide-for-vulnerability-management-5b5a59728456) |
| **HexStrike AI Guide** | AI-assisted authorized security research guide. Supporting offensive-informed defensive work, not the main professional identity. | [Guide](https://1200km.com/Hexstrike-AI-guide/) · [Repo](https://github.com/anpa1200/Hexstrike-AI-guide) |

Related supporting CTI assets: [CTI reports](https://github.com/anpa1200/CTI), [autoWF](https://github.com/anpa1200/autoWF), [Customer-Driven AI CTI Template](https://1200km.com/customer-driven-ai-cti-project-template/).
...
## Selected Medium Proof-Of-Work

- [CTI Kill Chain: An Analyst Guide With Real-World Evidence](https://medium.com/@1200km/cti-kill-chain-an-analyst-guide-with-real-world-evidence-c3bef6fd2979)
...
- [CTI Research: Kubernetes & Cloud-Native Threat Landscape](https://medium.com/@1200km/cti-research-kubernetes-cloud-native-threat-landscape-70373d6d7a87)
...
| Area | Projects |
|---|---|
| CTI methodology and training | [CTI as a Code](https://1200km.com/CTI_as_a_Code/) — lab stack (OpenCTI · TheHive · Elastic SIEM) + 8 structured analyst assignments across all four modes · [Repo](https://github.com/anpa1200/CTI_as_a_Code) |
| Malware analysis | [MalwareGraph](https://github.com/anpa1200/malwaregraph), [AIDebug](https://github.com/anpa1200/AIDebug), [Android-Malware-Analysis](https://github.com/anpa1200/Android-Malware-Analysis), [Static-malware-Analysis-Orchestrator](https://github.com/anpa1200/Static-malware-Analysis-Orchestrator), [Unpacker](https://github.com/anpa1200/Unpacker), [PE-Import-Analyzer](https://github.com/anpa1200/PE-Import-Analyzer), [String-Analyzer](https://github.com/anpa1200/String-Analyzer) |
